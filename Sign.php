    ...
    <div class="log-inpage">
      <div class="div">
        <div class="overlap-group">
          ...
          <div class="login-box">
            <form action="SignAc.php" method="post" class="overlap-group-2">
              ...
              <!-- Full Name -->
              <div class="overlap-2">
                <input type="text" name="fullname" id="fullname" class="rectangle-2" placeholder="Full Name" required />
              </div>

              <!-- Username -->
              <div class="overlap-3">
                <input type="text" name="username" id="username" class="rectangle-2" placeholder="Username" required />
              </div>
  ...
  <button type="submit" style="display: flex; align-items: center; justify-content: center; width: 150px; height: 45px; background-color: #3a86ff; border: none; border-radius: 6px; cursor: pointer; margin-top: -250px;">
    <div style="color: white; font-family: 'Montserrat', sans-serif; font-size: 16px; font-weight: 600; text-align: center;">
      Sign Up
              ...
              <!-- Forgot Password and Redirects -->  
              
              <p class="don-t-have-account">
                <span class="span">Already have an account? </span>
                <a href="login.php"><span class="text-wrapper-10">Log In</span></a>
              </p>
